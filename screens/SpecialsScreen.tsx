...
const SpecialsScreen: React.FC<SpecialsScreenProps> = ({ menuItems, onBack }) => {
  const specials = menuItems.filter((item: MenuItem) => item.course === 'specials');
  const courseInfo = COURSES.find((c) => c.id === 'specials');
