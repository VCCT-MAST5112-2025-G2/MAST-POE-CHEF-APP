...
const BeveragesScreen: React.FC<BeveragesScreenProps> = ({ menuItems, onBack }) => {
  const beverages = menuItems.filter((item: MenuItem) => item.course === 'beverages');
  const courseInfo = COURSES.find((c) => c.id === 'beverages');
